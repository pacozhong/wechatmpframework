...
class wechatCallbackapiTest
{
    ...
    public function responseMsg()
    {
	  ...
	  $MsgType = $postObj->MsgType; //视频消息的类型为"video",根据据用户发送不同消息自动识别返回给BAE不同值(text, image, event, voice, video,location)
      $MsgId  = $postObj->MsgId;   //视频消息内容的随机id		
      ...
      $msg .= "视频消息id: ".$MsgId."\n";
      $msg .= "视频消息类型: ".$MsgType."\n";
      $msg .= "视频消息媒体id: ".$MediaId."\n";
      $msg .= "视频消息缩略图的媒体id : ".$ThumbMediaId."\n";
	  $msg .= "视频发送过来的时间戳：".$CreateTime."\n";      
